...
sysctl_unregister_oid(&sysctl__pckeyboardhack_enable_control_l);
sysctl_unregister_oid(&sysctl__pckeyboardhack_keycode_control_l);
sysctl_unregister_oid(&sysctl__pckeyboardhack_enable_control_r);
sysctl_unregister_oid(&sysctl__pckeyboardhack_keycode_control_r);
