...
keycode_control_l = hid->_usb_2_adb_keymap[org_pqrs_PCKeyboardHack::KeyMapIndex::CONTROL_L];
keycode_control_r = hid->_usb_2_adb_keymap[org_pqrs_PCKeyboardHack::KeyMapIndex::CONTROL_R];
